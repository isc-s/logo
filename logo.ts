...
class Logo {
    ...
    private createGears() {
        ...
        ;[0, 1].map((i) => {
            ...
            const path = i == 0
                ? this.createGearPath(8, 40 - 1.5, Math.PI * 0.15 + additionalRotation, true)
                : this.createGearPath(6, 30, Math.PI * 0.3 - additionalRotation * gearRatio, false)
